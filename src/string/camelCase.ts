...
import helperStringSubstring from '../helpers/helperStringSubstring'
import helperStringUpperCase from '../helpers/helperStringUpperCase'
import helperStringLowerCase from '../helpers/helperStringLowerCase'
...
function camelCase (str) {
  ...
  let rest = str.replace(/([-]+)/g, function (text, flag, index) {
